...
- Status reconciled on 2026-09-26: the work was already on `main`, landed by `5066b05` (ci: run the repository's own verification on every change) via PR #20 (feat/production-readiness).
