...
- Status reconciled on 2026-09-26: the work was already on `main`, landed by `339e8f1` (perf(posts): a listing stops sending every Post's body) via PR #20 (feat/production-readiness).
