      ...
      <div className="flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-10">
          ...
          <button
            ...
            className="border-2 border-brand-dark px-8 py-4 rounded-xl text-lg font-medium hover:bg-brand-dark hover:text-white transition-all duration-300 active:scale-95 shadow-[4px_4px_0px_0px_rgba(25,26,35,1)] hover:shadow-none"
          >
            Get Started
          </button>
        </div>
